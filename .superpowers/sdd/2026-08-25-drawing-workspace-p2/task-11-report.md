...
| 10. Snapshot v2 determinism and approved mutation denial    | Nested PGlite tests `P2 review writes a deterministic complete v2 snapshot` and `P2 tables deny authenticated direct DML` pass; production `Gate 10` uses Editor, Reviewer, Viewer, and non-member clients, rereads unchanged rows after DML/RPC probes, and enforces maker-checker approval. | PGlite locally executed; production UNEXECUTED.                        |
...
wheel frames, 60 drag-pan frames, 20 real block-instance selections, 19 canvas
...
| Command                                                                                                                                                                                                                                                                         | Result                                                                                                        |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------- |
| `node --test tests/drawing-workspace-p2-contract.test.mjs`                                                                                                                                                                                                                      | PASS: 6/6, fail 0, skipped 0, todo 0.                                                                         |
| `npm run test:drawing-workspace`                                                                                                                                                                                                                                                | PASS: 417/417, fail 0, skipped 0, todo 0.                                                                     |
