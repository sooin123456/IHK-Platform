...
namespace THEKIE.Qto.StructuralFixtureTest
{
    internal static class Program
    {
        ...
        private static int Main(string[] args)
        {
            ...
            {
                Console.Error.WriteLine("Usage: THEKIE.Qto.StructuralFixtureTest <ZG02> <ZG03> <ZJ01> [<ZG04A> <ZJ02>]\n" +
                    "   or: THEKIE.Qto.StructuralFixtureTest --raw-hardening <ZG04A> <ZJ02>");
                return 2;
            }
        ...
        private static string CopyWithCell(string sourcePath, string address, string value, bool inlineText, string formula = null)
        {
            ...
            string copyPath = Path.Combine(Path.GetTempPath(), "thekie-structural-" + Guid.NewGuid().ToString("N") + extension);
