...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      lukas_qto_drawing_share_events: {
        Row: {
          actor_id: string;
          created_at: string;
          details: Json;
        ...
        Relationships: [
          {
            foreignKeyName: "lukas_qto_drawing_share_events_share_fkey";
            columns: [
              "share_id",
              "project_id",
              "document_id",
            ...
            isOneToOne: false;
            referencedRelation: "lukas_qto_drawing_shares";
            referencedColumns: [
              "id",
              "project_id",
              "document_id",
      ...
      lukas_qto_drawing_shares: {
        ...
        Relationships: [
          {
            foreignKeyName: "lukas_qto_drawing_shares_document_fkey";
            columns: ["document_id", "project_id"];
            isOneToOne: false;
            referencedRelation: "lukas_drawing_documents";
            referencedColumns: ["id", "project_id"];
          },
          {
            foreignKeyName: "lukas_qto_drawing_shares_project_id_fkey";
            columns: ["project_id"];
            isOneToOne: false;
            referencedRelation: "lukas_qto_projects";
            referencedColumns: ["id"];
          ...
          {
            foreignKeyName: "lukas_qto_drawing_shares_revision_fkey";
            columns: ["revision_id", "document_id", "project_id"];
            isOneToOne: false;
            referencedRelation: "lukas_drawing_revisions";
            referencedColumns: ["id", "document_id", "project_id"];
          },
          {
            foreignKeyName: "lukas_qto_drawing_shares_snapshot_fkey";
            columns: [
              "revision_id",
              "project_id",
              "revision_version",
            ...
            isOneToOne: false;
            referencedRelation: "lukas_drawing_snapshots";
            referencedColumns: [
              "revision_id",
              "project_id",
              "revision_version",
