...
namespace THEKIE.Qto
{
    ...
    {
        private const string TabName = "Lukas QTO";
        private const string PanelName = "수량·검산";
        ...
        public Result OnStartup(UIControlledApplication application)
        {
            try
            {
                ...
                var extractButton = new PushButtonData(
                    ...
                    "수량 산출",
                    assemblyPath,
                    "THEKIE.Qto.Commands.ExtractQuantitiesCommand")
                {
                ...
                panel.AddItem(new PushButtonData(
                    ...
                    "Properties\n추출",
                    assemblyPath,
                    "THEKIE.Qto.Commands.ExportElementPropertiesCommand")
                {
                ...
                var packageButton = new PushButtonData(
                    ...
                    "IFC·QTO\n내보내기",
                    assemblyPath,
                    "THEKIE.Qto.Commands.ExportIfcQtoPackageCommand")
                {
                ...
                var ifcButton = new PushButtonData(
                    ...
                    "IFC 내보내기",
                    assemblyPath,
                    "THEKIE.Qto.Commands.ExportIfcCommand")
                {
            ...
            {
                TaskDialog.Show("Lukas QTO", "애드인 초기화 실패:\n" + ex.Message);
