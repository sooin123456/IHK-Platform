...
The canonical command could not start or stop Supabase because no container engine exists. In accordance with recovery safety, it did not delete the root after the start/stop failure. The new retained root is `/private/var/folders/b_/z50hcv3524lc6wsbcqncd2q40000gn/T/1hk-m1-supabase-byEPd5`; exact cleanup-target validation confirms project `1hk-m1-a9fe0b64`, API port 52549, DB port 52550, canonical marker/config, containment, and no symlink, while independent probes confirm both ports closed. It contains no executed M1 fixture data. Previously disclosed roots `/private/var/folders/b_/z50hcv3524lc6wsbcqncd2q40000gn/T/1hk-m1-supabase-VvWi6t` (`1hk-m1-9cb85afd`, 53965/53966) and `/private/var/folders/b_/z50hcv3524lc6wsbcqncd2q40000gn/T/1hk-m1-supabase-cqxuKX` (`1hk-m1-b19ec770`, 54543/54544) also remain after their earlier failures. All three residues are disclosed for operator recovery and were not deleted.
